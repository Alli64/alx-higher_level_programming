...
class Base:
    ...
    def save_to_file(cls, list_objs):
        """write JSON srializzation of list of objects to a file"""
    ...
    def create(cls, **dictionary):
        """return a class instantied from dictionary of attributes"""
    ...
    def save_to_file_csv(cls, list_objs):
        """write CSV serialization of list of a file"""
    ...
    def draw(list_rectangle, list_squares):
        """draw rectangles ad sqaures using turtle module"""
        turt = turtle.Turtle()
